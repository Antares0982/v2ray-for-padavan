...
echo ""
echo "#stop v2ray"
echo "sh /media/AIDISK/v2ray/stop.sh"
echo ""
echo "#Default config.json use GFW Mode"
echo ""
echo "[media/AIDISK/v2ray/example-config]"
echo ""
echo "#Autoruns:"
echo "'Scripts' - 'Run After Firewall Rules Restarted'"
echo "sleep 10"
echo "sh /media/AIDISK/v2ray/start.sh"
echo ""
echo "USE 5353 DNS FOR GFWLIST:"
echo "Custom 'dnsmasq.conf'"
echo "conf-dir=/media/AIDISK/v2ray/dnsmasq-gwlist/, *.hosts"
echo ""
